...
// 		},
// 		{path: '/dashboard/default',title: 'Dashboards', icon: 'home', type: 'link', badgeType: 'success',  active: true},
		{
        			title: 'Anchor', icon: 'anchor', type: 'sub', active: false, children: [
        			{ path: '/email/anchor-details', title: 'Anchor Details', type: 'link' },
                    					{ path: '/email/new-anchor', title: 'New Anchor', type: 'link' },
                    					{ path: '/email/AnchorRenewal', title: 'Renewal/Enhancement', type: 'link' },
//                     					{ path: '/email/AnchorEnhancement', title: 'Anchor Enhancement', type: 'link' },
                    					],
        },
        {
			title: 'Counter Party', icon: 'users', type: 'sub', active: false, children: [
					{ path: '/form/counter-party-details', title: 'Counter party Details', type: 'link' },
					{ path: '/form/new-counter', title: 'New Counter party', type: 'link' },
					{ path: '/form/counter-party-renewal', title: 'Renewal/Enhancement', type: 'link' },
// 					{ path: '/form/counter-party-enhancement', title: 'Counter party Enhancement', type: 'link' },
			],
		},
        {path:'/email/exploreProgram',title: 'Explore Programs', icon: 'airplay', type: 'link', badgeType: 'success',  active: false},
        {path: '/email/disbursement',title: 'Disbursement', icon: 'minimize-2', type: 'link', badgeType: 'success',  active: false},
        {path:'/email/collection',title: 'Collection', icon: 'credit-card', type: 'link', badgeType: 'success',  active: false},
        {
        			title: 'Document', icon: 'repeat', type: 'sub', active: false, children:
        			[
        			{path:'/email/Document',title: 'Library', icon: 'repeat', type: 'link', badgeType: 'success',  active: false},
        			{path:'/email/Deferral', title: 'Deferral', type: 'link', badgeType: 'success',  active: false},
                    {path:'/email/Workflow', title: 'Workflow', type: 'link', badgeType: 'success',  active: false},

        			],
        },
//         {path:'/email/Document',title: 'Document', icon: 'repeat', type: 'link', badgeType: 'success',  active: false},
        {path:'/dashboard/inbox',title: 'Inbox', icon: 'inbox', type: 'link', badgeType: 'success',  active: false},
        {path:'/dashboard/report',title: 'Report', icon: 'file-text', type: 'link', badgeType: 'success',  active: false},
        {path:'/dashboard/version',title: 'Version', icon: 'info', type: 'link', badgeType: 'success',  active: false},
        {path:'/dashboard/assignment',title: 'Assignment', icon: 'send', type: 'link', badgeType: 'success',  active: false},
//         {title: 'My Preferences', icon: 'settings', type: 'link', badgeType: 'success',  active: false},
