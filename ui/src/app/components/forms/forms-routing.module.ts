...
import { NewCounterPartyComponent } from './new-counter-party/new-counter-party.component';
import { CounterpartyRenewalComponent } from './counterparty-renewal/counterparty-renewal.component';
import { CounterpartyEnhancementComponent } from './counterparty-enhancement/counterparty-enhancement.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
          path: "new-counter",
          component: NewCounterPartyComponent
        },

        {
                  path: "counter-party-renewal",
                  component: CounterpartyRenewalComponent
                },
                {
                   path: "counter-party-enhancement",
                   component: CounterpartyEnhancementComponent
                                },
